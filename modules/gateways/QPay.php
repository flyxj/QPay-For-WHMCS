...
{
    return array( "DisplayName" => "QQ钱包支付(NeWorld)", "APIVersion" => "1.1", "DisableLocalCredtCardInput" => true, "TokenisedStorage" => false );
}

function QPay_config()
{
    $configarray = array( "FriendlyName" => array( "Type" => "System", "Value" => "QQ钱包支付(NeWorld)" ), "MCHID" => array( "FriendlyName" => "商户号", "Type" => "text", "Size" => "32" ), "KEY" => array( "FriendlyName" => "商户支付密钥", "Type" => "text", "Size" => "32" ), "checkTime" => array( "FriendlyName" => "检查时间", "Type" => "text", "Size" => "5", "Default" => "5", "Description" => "单位：秒 支付状态检查间隔" ) );
    return $configarray;
}
